...
Claim creation + signing & 0.762 \\
Trace (100-claim chain) & 1.456 \\
Effective confidence (single) & 1.357 \\
Effective confidence (bulk, 100) & 1.875 \\
Audit (100 claims) & 3.837 \\
Stats (100 claims) & 3.606 \\
Verify all signatures (100+) & 43.172 \\
\bottomrule
\end{tabular}
\end{table}
